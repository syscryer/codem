          ...
          filteredProjects.map((project) => (
            <div key={project.id} className={`sidebar-project ${project.id === activeProjectId ? 'active' : ''}`}>
              <div className="sidebar-project-row">
                <button type="button" className="sidebar-project-title" onClick={() => void onSelectProject(project.id)}>
              ...
              <button type="button" className="sidebar-collapse-toggle" onClick={() => onToggleProjectCollapse(project.id)}>
