...
按原版 Node claude-service.ts 的状态机完整迁移 request-user-input 与 approval-request 相关逻辑到 Rust 后端，并用真实 Claude 验证
...
- 2026-07-04T18:48:34.500Z Task created by Trellis automation.
