...
以官方 kimi acp stdio 入口将 Kimi Code 接入 CodeM 共享 ACP 驱动，使用 MiniMax API 完成端到端验证
...
- 2026-09-02T17:19:24.846Z Task created by Trellis automation.
